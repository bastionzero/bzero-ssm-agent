...
// ValidateDataMessage provides a mock function with given fields: datapayload
func (_m *IKeysplittingHelper) ValidateDataMessage(datapayload contracts.DataPayload) error {
	ret := _m.Called(datapayload)
